                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocBuilder<MovieDetailWatchlistStatusBloc,
                                MovieDetailWatchlistStatusState>(
                              builder: (context, state) {
                                if (state
                                    is MovieDetailWatchlistStatusHasData) {
                                  ...
                                  if (message ==
                                    ...
                                    Future.delayed(const Duration(milliseconds: 100),
                                      ...
                                      context.read<MovieDetailWatchlistStatusBloc>().add(ResetMessage(state.isAddedtoWatchlist));
                                    });
